function toggleImage() {
    ...
    if (waifu.src.endsWith('/images/kafka.jpg')) {
        waifu.src = '/images/kafkanig.jpg';
        status.textContent = 'Kafka Hitam';
    } else {
        waifu.src = '/images/kafka.jpg';
        status.textContent = 'Kafka Putih';
    }
}
