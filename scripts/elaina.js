function toggleImage() {
    ...
    if (waifu.src.endsWith('/images/elaina.jpg')) {
        waifu.src = '/images/elainanig.jpg';
        status.textContent = 'Elaina Hitam';
    } else {
        waifu.src = '/images/elaina.jpg';
        status.textContent = 'Elaina Putih';
    }
}
